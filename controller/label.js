...
class ControllerClass {
    ...
    createLabelIncontroller(req,res){
        ...
        if(errors)
        {
            ...
            //  new Promise((resolve,reject)=>{
                const response={}
                serviceClassObject.createLabelInService(createLabelData)
                .then(data=>{
    ...
    getAllLabelsIncontroller(req,res){
        ...
        serviceClassObject.getAllLabelsInService()
        .then(data=>{
            const response={}
            response.success=true;
            // response.message='';
    ...
    editLabelIncontroller(req,res){
        ...
        if(errors)
        {
            ...
            serviceClassObject.editLabelInService(editData)
            .then(data=>{
    ...
    removeLabelIncontroller(req,res){
        ...
        if(errors)
        {
            ...
            new Promise((resolve, reject)=>{
                serviceClassObject.removeLabelInService(removeData)
                .then(data=>{
